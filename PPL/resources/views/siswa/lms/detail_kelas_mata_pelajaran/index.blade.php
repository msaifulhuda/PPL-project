    ...
    <div class="p-2 mx-4 my-6 bg-white rounded-lg shadow xl:p-6">
        ...
        <div class="px-3">
            ...
            <div class="flex gap-2 mb-4 mt-6">
                <a href="#" class="px-6 py-2 border border-black font-semibold text-gray-700 bg-gray-100 rounded-lg">Forum</a>
                <a href="" class="px-6 py-2 border border-black font-semibold text-gray-700 bg-gray-100 rounded-lg">Tugas Kelas</a>
                <a href="" class="px-6 py-2 border border-black font-semibold text-gray-700 bg-gray-100 rounded-lg">Anggota</a>
            </div>
