        ...
        <div class="flex flex-col gap-4 mt-4 md:flex-row">
            ...
            <div class="flex-1 lg:max-w-[40%]">
                <div class="p-4 bg-white">
                    <h2 class="mb-4 text-xl font-bold">Tugas Mendatang</h2>

                    @foreach ($mataPelajaranList as $mapel)
                        <div class="mb-6 p-4 border border-black rounded-xl">
                            <h3 class="text-lg font-medium">{{ $mapel->mataPelajaran->nama_matpel }}</h3>
                                ...
                                @foreach ($mapel->tugas as $tugas)
                                    <div class="mt-2">
                                        ...
                                        <p class="text-xs text-gray-500">
                                            Tenggat: {{ \Carbon\Carbon::parse($tugas->deadline)->format('l, d F Y') }}
                                        </p>
                                    </div>
                                @endforeach
                            @else
