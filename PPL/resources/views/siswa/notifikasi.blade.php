        ...
        <div class="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <ul class="mt-4 space-y-4">
                ...
                <li class="p-4 bg-gray-100 rounded-lg shadow">
                    ...
                    <div>
                        <a href="{{ route('siswa.dashboard.lms.materi', ['id' => $item->id_materi]) }}" class="text-sm font-medium text-blue-600 hover:underline">{{ $item->judul_materi }}</a>
                        <p class="text-sm text-gray-500">{{ Str::limit($item->deskripsi, 50) }}</p>
                    </div>
