    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-50 py-12">
        <div class="max-w-6xl w-full p-8 bg-white rounded-lg shadow-md border-2 border-black">
            <nav class="text-sm text-gray-500 mb-4">
                <a href="{{ route('superadmin.dashboard') }}" class="text-black-500 hover:underline">Dashboard</a> > Kelola Akun > <a href="{{ route('superadmin.keloladataguru') }}" class="text-black-500 hover:underline">Kelola Data Guru</a> > <b>Edit Data Guru</b>
            </nav>
