    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-12">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <nav class="text-sm text-gray-500 mb-4">
                ...
                <a href="{{ route('superadmin.kelola_staff_perpus') }}" class="text-black-500 hover:underline"><b>Kelola Akun Staff Perpustakaan</b></a>
            </nav>
            <h3 class="text-lg font-semibold mb-4">Kelola Akun Staff perpustakaan</h3>
            <div class="mb-4 flex justify-between items-center">
                <div>
                    <a href="{{ route('superadmin.kelola_staff_perpus.create') }}" class="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600">Tambah Data</a>
                </div>
            </div>
                ...
                <table class="min-w-full " id="selection-table">
                    ...
                    <tbody class="text-gray-600 text-sm font-light">
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-left">
                                <div class="flex items-center">
                                    <span>{{ $staff->alamat_staff_perpustakaan }}</span>
                                </div>
                            </td>
