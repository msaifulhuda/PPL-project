<x-admin-layout>
    ...
    <div class="container mx-auto p-12 ">
        <div class="flex justify-between items-center mb-4">
            <h1 class="text-2xl font-semibold">Kelola Akun Staff Akademik</h1>
            <a href="{{ route('superadmin.kelola_staff_akademik.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Tambah User</a>
        </div>
