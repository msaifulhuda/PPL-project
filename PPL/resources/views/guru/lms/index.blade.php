    ...
    <div class="p-2 mx-4 my-6 bg-white rounded-lg shadow xl:p-6">
        ...
        <div class="flex px-3 md:flex-row">
            ...
            <div class="flex flex-col gap-4 mt-6 ">
                <h2 class="mb-2 text-3xl font-semibold text-gray-800">Kelas</h2>
                                ...
                                <div
                                    ...
                                    <div>
                                        <h4 class="text-lg lg:text-xl font-semibold text-gray-800">
                                            {{ $kelas->mataPelajaran->nama_matpel }}</h4>
                                        </h4>
                                        <p class="text-sm text-gray-500">{{ $kelas->hari->nama_hari }},
                                            {{ $kelas->waktu_mulai }} - {{ $kelas->waktu_selesai }} WIB</p>
                                        <p class="text-sm text-gray-500">Kelas {{ $kelas->kelas->nama_kelas }}</p>
                                    </div>
                                </div>
                            </a>
                        @endforeach
