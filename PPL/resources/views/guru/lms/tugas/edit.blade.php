                ...
                <div class="md:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="4"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('deskripsi', $tugas->deskripsi) }}</textarea>
                    </div>

                    <!-- Existing Files -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">File Tugas Sebelumnya</label>
                        <div class="space-y-2">
