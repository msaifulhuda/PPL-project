<x-staffakademik-layout>
    <div class="container mx-auto p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 max-w-4xl">
        ...
        <div class="mt-8 text-center">
            <a href="{{ route('prestasi.index') }}" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800">
                Kembali
            </a>
        </div>
    </div>
