                ...
                <li>
                    ...
                    <x-sidebar-dropdown-list id="perpustakaan" :active="request()->is('siswa/dashboard/perpustakaan*')">
                        <li>
                            ...
                            <x-sidebar-dropdown-list-link href="{{ route('dashboard.perpustakaan') }}" :active="request()->is('dashboard/perpustakaan/beranda')">Beranda</x-sidebar-dropdown-list-link>
                ...
                {{-- Ekstrakurikuler --}}
                    ...
                    <li>
                        ...
                        <x-sidebar-dropdown-list id="ekstrakurikuler" :active="request()->is('siswa/ekstrakurikuler*')">
                            <li>
                                <x-sidebar-dropdown-list-link href="{{ route('pengurus_ekstra.dashboard') }}" :active="request()->is('siswa/ekstrakurikuler/beranda')">Beranda</x-sidebar-dropdown-list-link>
                            </li>
                            <li>
                                <x-sidebar-dropdown-list-link href="{{ route('pengurus_ekstra.anggota') }}" :active="request()->is('siswa/ekstrakurikuler/anggota')">Anggota</x-sidebar-dropdown-list-link>
                            </li>
                            {{-- <li>
                            ...
                            <li>
                                <x-sidebar-dropdown-list-link href="{{ route('pengurus_ekstra.perlengkapan') }}" :active="request()->is('siswa/ekstrakurikuler/perlengkapan')">Perlengkapan</x-sidebar-dropdown-list-link>
                            </li>
                        </x-sidebar-dropdown-list>
                    </li>
