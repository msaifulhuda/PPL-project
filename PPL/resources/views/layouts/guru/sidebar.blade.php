                ...
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        ...
                        <x-sidebar-dropdown-list id="ujian" :active="request()->is('guru/dashboard/ujian*')">
                            <li>
                                <x-sidebar-dropdown-list-link href="{{ route('ujian.show') }}" :active="request()->is('guru.dashboard.ujian.jawaban_ujian')">
                                    Beranda Ujian
                                </x-sidebar-dropdown-list-link>
                            </li>
                            <li>
                            ...
                            <li>
                                <x-sidebar-dropdown-list-link href="{{ route('guru.dashboard.ujian.create_ujian') }}" :active="request()->is('guru/dashboard/ujian/soal_ujian')">
                                    Buat Ujian
                                </x-sidebar-dropdown-list-link>
                            </li>
                            <li>
