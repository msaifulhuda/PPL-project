    ...
    <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
        <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
            ...
            <ul class="pb-2 space-y-2">
                ...
                {{-- Overview --}}
                <li>
                    <x-sidebar-link href="{{ route('guru.dashboard') }}" :active="request()->is('dashboard')">
                        <x-sidebar-icon>
                ...
                {{-- Ekstrakurikuler --}}
                <li>
                    <x-sidebar-dropdown label="Ekstrakuriler" id="ekstrakurikuler" :active="request()->is('dashboard/ekstrakurikuler*')">
                        <x-sidebar-icon>
                    ...
                    <x-sidebar-dropdown-list id="ekstrakurikuler" :active="request()->is('dashboard/ekstrakurikuler*')">
                        <li>
                            <x-sidebar-dropdown-list-link href="dashboard/lms" :active="request()->is('dashboard/ekstrakurikuler/beranda')">Beranda</x-sidebar-dropdown-list-link>
                        </li>
                    </x-sidebar-dropdown-list>
                </li>
